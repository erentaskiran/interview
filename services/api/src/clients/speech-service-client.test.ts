...
describe("SpeechServiceClient", () => {
  ...
  describe("textToSpeech", () => {
    ...
    it("throws on non-ok response", async () => {
      ...
      await expect(client.textToSpeech("Hello")).rejects.toThrow("Speech TTS failed with status 500");
    });
  });
  ...
  describe("speechToText", () => {
    ...
    it("throws on non-ok response", async () => {
      ...
      await expect(client.speechToText("base64audio", "audio/wav")).rejects.toThrow("Speech STT failed with status 400");
    });
    ...
    it("throws when transcript is empty", async () => {
      ...
      await expect(client.speechToText("base64audio", "audio/wav")).rejects.toThrow("Speech STT returned empty transcript");
    });
  });
});
